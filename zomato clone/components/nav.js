function searchbar(){
  return  `
  <div class="sc-18n4g8v-0 gAhmYY sc-boCWhm gSAYHd">
      ...
      <input placeholder="Doon Vihar, Jakhan, Dehradun" class="sc-cIsjWt fsKPDc" value="">
          ...
          </svg> <h3 class="dandi">|</h3>
      <div class="sc-18n4g8v-0 gAhmYY sc-jHXLhC gHRJep"> 
          <div id="searchlogo" class="sc-fgrSAo hgVzAq">
          ...
          <input id="restaurant_name" placeholder="Search for restaurant " class="sc-iFUGim eBYlFm" value="">
      </div>
  </div>
    `
}
